...
import com.think.guoyh.data.module.db.BookRecordBean;
import com.think.guoyh.data.module.db.CollBookBean;
import com.think.guoyh.data.module.db.dbManage.BookRepository;
import com.think.guoyh.utils.text.DateUtli;
import com.think.guoyh.utils.text.IOUtils;
import com.think.guoyh.utils.text.RxUtils;
import com.think.guoyh.utils.text.ScreenUtils;
import com.think.guoyh.utils.text.StringUtils;
...
public abstract class PageLoader {
    ...
    private void initPaint() {
        ...
        mSelectPaint.setColor(mContext.getResources().getColor(R.color.colorPrimary));
    ...
    private void prepareBook() {
        mBookRecord = BookRepository.getInstance().getBookRecord(mCollBook.getId());
    ...
    private void drawBackground(Bitmap bitmap, boolean isUpdate) {
        ...
        //底部的字显示的位置Y
        float y = mDisplayHeight - mTipPaint.getFontMetrics().bottom - tipMarginHeight;
        String time = DateUtli.dateConvert(System.currentTimeMillis(), Const.FORMAT_TIME);
