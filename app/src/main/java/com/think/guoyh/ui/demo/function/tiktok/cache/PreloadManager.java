package com.think.guoyh.ui.demo.function.tiktok.cache;
...
public class PreloadManager {
    ...
    public void addPreloadTask(String rawUrl, int position) {
        ...
        Logger.dd("addPreloadTask: " + position);
    ...
    public void pausePreload(int position, boolean isReverseScroll) {
        Logger.dd("pausePreload：" + position + " isReverseScroll: " + isReverseScroll);
    ...
    public void resumePreload(int position, boolean isReverseScroll) {
        Logger.dd("resumePreload：" + position + " isReverseScroll: " + isReverseScroll);
