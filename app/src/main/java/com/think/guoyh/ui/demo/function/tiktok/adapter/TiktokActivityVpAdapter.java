...
import com.think.guoyh.widget.TikTokView;

import java.util.ArrayList;
import java.util.List;

public class TiktokActivityVpAdapter extends PagerAdapter {
    /**
    ...
    public TiktokActivityVpAdapter(List<TiktokBean> videoBeans) {
