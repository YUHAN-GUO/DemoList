package com.think.guoyh.data.module.db.dbManage;
...
import com.think.guoyh.data.module.db.DownloadTaskBean;
import com.think.guoyh.utils.text.FileUtils;
import com.think.guoyh.utils.text.IOUtils;
import com.think.guoyh.utils.text.SpUtil;
import com.think.guoyh.widget.page.Void;
...
//                .list();
        ...
        if (SpUtil.getBooleanValue(Const.BookSort, false)) { //默认根据阅读时间排序
...
//                .unique();
    ...
    public ChapterInfoBean getChapterInfoBean(String folderName, String fileName) {
        File file = new File(Const.BOOK_CACHE_PATH + folderName
...
//        mCollBookDao.delete(collBook);
    ...
    public void deleteBook(String bookId) {
        FileUtils.deleteFile(Const.BOOK_CACHE_PATH + bookId);
    }
