...
import static com.think.guoyh.widget.page.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String convertCC(String input) {
        ...
        if (input.length() == 0) {
            ...
            if (convertType == 1) {
                input = ZHConverter.getInstance(ZHConverter.TRADITIONAL).convert(input);
            }
        }
        return input;
    }
