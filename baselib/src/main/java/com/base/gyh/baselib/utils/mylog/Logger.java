...
public class Logger {
    ...
    private static String PRIVATE_TAG = "能量盒子";
    private static String PUBLIC_TAG = "能量盒子";
    ...
    private static final String myFormat = "nlhzguoyh======>>>>%s";
    ...
    public static void ddd(String tag, String msg) {  //信息太长,分段打印
