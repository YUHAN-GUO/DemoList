...
//                    Logger.dd(height+"--------------"+parentY+"---------------"+event.getRawY()+"-------------"+initTranslationY+"--------------"+viewMoveY);
                    if (event.getRawY() >= height||event.getRawY()<=300){
//                        float bottom = viewMoveY;
//                        setTranslationY(viewMoveY);
                    }else{
